...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lable_tabletext = QtWidgets.QLabel(parent=self.centralwidget)
        self.lable_tabletext.setObjectName("lable_tabletext")
        self.horizontalLayout_2.addWidget(self.lable_tabletext)
        self.combobox_chose_window = QtWidgets.QComboBox(parent=self.centralwidget)
        ...
        self.btn_update_table = QtWidgets.QPushButton(parent=self.centralwidget)
        self.btn_update_table.setObjectName("btn_update_table")
        self.horizontalLayout_2.addWidget(self.btn_update_table)
        self.btn_execute_sql = QtWidgets.QPushButton(parent=self.centralwidget)
        ...
        self.tableWidget_database_content = QtWidgets.QTableWidget(parent=self.centralwidget)
        ...
        self.verticalLayout_main.addWidget(self.tableWidget_database_content)
